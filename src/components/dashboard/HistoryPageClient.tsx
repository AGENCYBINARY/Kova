    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.stats}>
          ...
          <Card className={styles.statCard}>
            <span className={styles.statValue}>{executionHistory.filter((entry) => entry.status === 'failed').length}</span>
            <span className={styles.statLabel}>{t.history.failed}</span>
          </Card>
          <Card className={styles.statCard}>
            <span className={styles.statValue}>{executionHistory.filter((entry) => entry.status === 'rejected').length}</span>
